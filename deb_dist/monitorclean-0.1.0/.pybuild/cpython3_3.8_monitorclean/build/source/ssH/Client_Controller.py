...
class ClientWrapper:
    ...
    """
    def __init__(self, mainwindow,hostname: str, username: str, password: str, port: int = 22, osType: str = "linux"):
        ...
        self.__port = port
        self.stdobject = STD_object(self.mainwindow,self,"utf-8",2000)
...
class Client_Controller:
    ...
    def add_client(self, hostname: str, username: str, password: str, port: int = 22, osType: str = "linux") -> None:
        ...
        self._clients[hostname] = ClientWrapper(self.mainwindow,hostname, username, password, port, osType=osType)
